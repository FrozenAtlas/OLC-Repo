...
// Version: 0.0.1
// Event: Any Event
// Description: Runs a tween on a Lens Studio face stretch feature
...
{
    updateComponentValue( script.sceneObject, "Component.FaceStretchVisual", value );
}
...
function updateComponentValue( sceneObject, componentName, value ) 
{
    for( var i = 0; i < sceneObject.getComponentCount( componentName); i++ ) 
    {
        ...
        visual.setFeatureWeight( script.featureName, value.a );
    }
    ...
    if( script.recursive ) 
    {
        ...
        {
            updateComponentValue( sceneObject.getChild(i), componentName, value.a );
        }
    }
}
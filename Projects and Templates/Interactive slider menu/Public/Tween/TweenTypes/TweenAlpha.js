...
function setupTween()
{
    ...
    setupAlphaComponentTweens("Component.MeshVisual", script.api.sceneObject);

    setupAlphaComponentTweens("Component.SpriteVisual", script.api.sceneObject);

    setupAlphaComponentTweens("Component.FaceMaskVisual", script.api.sceneObject);

    setupAlphaComponentTweens("Component.PostEffectVisual", script.api.sceneObject);

    setupAlphaComponentTweens("Component.Label", script.api.sceneObject);

    setupAlphaComponentTweens("Component.FaceInsetVisual", script.api.sceneObject);

    setupAlphaComponentTweens("Component.EyeColorVisual", script.api.sceneObject);
...
function getVisualComponentAlpha(visual){
    var color = visual.getMaterial(0).getPass(0).baseColor;

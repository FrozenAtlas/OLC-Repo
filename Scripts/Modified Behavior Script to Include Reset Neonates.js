// Originally uploaded by Ben (OLC) Electricsynapse#2395
...
// -----------------	
 //@input string triggeringEventType = "TouchEvent" {"widget": "combobox", "values": [{"value": "TouchEvent", "label": "Touch Event"}, {"value": "FaceEvent", "label": "Face Event"}, {"value": "TurnOnEvent", "label": "Lens Turned On"}, {"value": "UpdateEvent", "label": "Update"}, {"value": "LateUpdateEvent", "label": "Late Update"}, {"value": "CameraFrontEvent", "label": "Front Camera"}, {"value": "CameraBackEvent", "label": "Back Camera"}, {"value": "animationEnd", "label": "Animation End"}, {"value": "tweenEnd", "label": "Neonate End"}, {"value": "lookingAt", "label": "Looking At"}, {"value": "distanceCheck", "label": "Distance Check"}, {"value": "onCustomTrigger", "label": "On Custom Trigger"}, {"value": "None", "label": "None"}], "label": "Trigger"}	
...
//@input string tweenEndTweenName {"showIf": "triggeringEventType", "showIfValue": "tweenEnd", "label": "Neonate Name"}	
...
//@ui {"widget": "group_end"}	
//@ui {"widget": "separator"}	
//@input string responseType = "None" {"widget": "combobox", "values": [{"value": "None", "label": "None"}, {"value": "animateSprite", "label": "Animate Sprite"}, {"value": "animateMesh", "label": "Animate Mesh"}, {"value": "playSound", "label": "Play Sound"}, {"value": "setEnabled", "label": "Set Enabled"}, {"value": "setColor", "label": "Set Color"}, {"value": "setTexture", "label": "Set Texture"}, {"value": "runTween", "label": "Run Neonate"}, {"value": "setPosition", "label": "Set Position"}, {"value": "setRotation", "label": "Set Rotation"}, {"value": "setScale", "label": "Set Scale"}, {"value": "setBillboardPosition", "label": "Set Billboard Position"}, {"value": "setBillboardRotation", "label": "Set Billboard Rotation"}, {"value": "setBillboardSize", "label": "Set Billboard Size"}, {"value": "printMessage", "label": "Print Message"}, {"value": "sendCustomTrigger", "label": "Send Custom Trigger"}]}	
...
//@input string runTweenTweenName {"showIf": "responseType", "showIfValue": "runTween", "label": "Neonate Name"}	
//@input string runTweenAction = "Start" {"showIf": "responseType", "showIfValue": "runTween", "values": [{"value": "Start", "label": "Start"}, {"value": "Stop", "label": "Stop"}, {"value": "Pause", "label": "Pause"}, {"value": "Resume", "label": "Resume"}, {"value": "Reset", "label": "Reset"}], "widget": "combobox", "label": "Action"}	
...
setupTrigger();	
 ...
 function setupTweenEnd() {	
    if (!global.tweenManager) {	
        debugPrint("Could not find global.tweenManager - have you added Neonate Manager to your project?");	
        return;	
    }	
 ...
 function triggerRunTween() {	
    if (!script.runTweenTweenName) {	
        debugPrint("Neonate Name must be set!");	
        return;	
    }	
    if (!global.tweenManager) {	
        debugPrint("Could not find global.tweenManager - have you added Neonate Manager to your project?");	
    ...
    switch (script.runTweenAction) {	
        ...
        case "Resume":	
            ...
            break;	
        case "Reset":	
            global.tweenManager.resetObject(obj, script.runTweenTweenName);	
            break;	
    }	
}	

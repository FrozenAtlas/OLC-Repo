...
// @input Component.SpriteVisual backgroundColorBillboard
// @input Component.SpriteVisual imageBillboard
...
function onTapped(eventData)
{
    ...
    {
    script.imageBillboard.mainPass.baseTex = script.textures[count];
    }
...
function configureFillImage()
{
	...
	script.imageBillboard.mainPass.baseTex = script.textures[count];
	script.imageBillboard.fillMode = script.fillMode;
}

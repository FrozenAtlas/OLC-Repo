...
function setupTween()
{
    ...
    setupAlphaComponentTweens("Component.MeshVisual", script.sceneObject);

    setupAlphaComponentTweens("Component.SpriteVisual", script.sceneObject);

    setupAlphaComponentTweens("Component.FaceMaskVisual", script.sceneObject);

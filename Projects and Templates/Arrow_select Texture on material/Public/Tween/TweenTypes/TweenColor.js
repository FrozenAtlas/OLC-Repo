...
function setupTween()
{
    ...
    setupColorComponentTweens("Component.MeshVisual", script.api.sceneObject);

    setupColorComponentTweens("Component.SpriteVisual", script.api.sceneObject);

    setupColorComponentTweens("Component.FaceMaskVisual", script.api.sceneObject);

    setupColorComponentTweens("Component.PostEffectVisual", script.api.sceneObject);

    setupColorComponentTweens("Component.Label", script.api.sceneObject);

    setupColorComponentTweens("Component.FaceInsetVisual", script.api.sceneObject);
    
    setupColorComponentTweens("Component.EyeColorVisual", script.api.sceneObject);

    return script.api.tween;
}

// Create Tweens for specific Visual Component (e.g. MeshVisual, SpriteVisual, etc.)
function setupColorComponentTweens( componentType, sceneObject )
{
    for ( var i = 0; i < sceneObject.getComponentCount(componentType); i++)
    {
        var visualComponent = sceneObject.getComponentByIndex(componentType, i);
...
// Update single Visual Component (e.g. MeshVisual, SpriteVisual, etc.)
